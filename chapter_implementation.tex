...
\end{lstlisting}
The current expiration time for a signature (and in extension message) is 10 seconds. This ensures that an attacker cannot use a replay attack to maliciously control the system and if something goes wrong, that outdated packets don't influence behavior.
